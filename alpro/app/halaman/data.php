<?php 
   ...
   $mahasiswa = query("SELECT * FROM user LIMIT $awalData, $jumlahDataPerHalaman");
    ...
    <div class="container">
        ...
        <table>
            ...
            <tr>
                ...
                <td><?= $mhs["email"]?></td>
                <td>
                    <img src="../../public/img/<?= $mhs["gambar"];?>" width="40">
                </td>
                <td>
                    <a href="../fungsi/ubah.php?id=<?= $mhs["id_mhs"];?>" onclick="return confirm('Yakin?');">Ubah</a> |
                    <a href="../fungsi/hapus.php?id=<?= $mhs["id_mhs"];?>" onclick="return confirm('Yakin?');">Hapus</a>
                </td>
            </tr>
            <?php $inc++;?>
            <?php endforeach;?>
